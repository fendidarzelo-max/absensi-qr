...
class _DaftarHadirGuruPageState extends State<DaftarHadirGuruPage> {
  ...
  final List<Guru> _guruList = [
    const Guru(nip: "19850101201001", nama: "Ustadz Ahmad Fauzi", mapel: "Bahasa Arab", kelas: "KLS II MA", status: "Hadir"),
    const Guru(nip: "19850102201002", nama: "Ustadzah Maryam", mapel: "Fiqih", kelas: "KLS I MI", status: "Hadir"),
    const Guru(nip: "19850103201003", nama: "Ustadz Mansyur", mapel: "Tahfidz", kelas: "Semua Kelas", status: "Hadir"),
    const Guru(nip: "19850104201004", nama: "Ustadz Zaid", mapel: "Matematika", kelas: "KLS I MA", status: "Izin"),
    const Guru(nip: "19850105201005", nama: "Ibu Rahma", mapel: "Sejarah Islam", kelas: "KLS III MA", status: "Hadir"),
    const Guru(nip: "19850106201006", nama: "Ustadz Yusuf", mapel: "Aqidah Akhlak", kelas: "KLS III MI", status: "Hadir"),
    const Guru(nip: "19850107201007", nama: "Ustadz Hamzah", mapel: "Bahasa Inggris", kelas: "KLS II MI", status: "Sakit"),
    const Guru(nip: "19850108201008", nama: "Ibu Siti", mapel: "Bahasa Indonesia", kelas: "KLS I MI", status: "Hadir"),
    const Guru(nip: "19850109201009", nama: "Pak Rudi", mapel: "Fisika", kelas: "KLS I MTS", status: "Hadir"),
    const Guru(nip: "19850110201010", nama: "Ibu Dewi", mapel: "Kimia", kelas: "KLS III MA", status: "Alpha"),
  ];
                  ...
                  return Container(
                    ...
                    child: ListTile(
                      leading: CircleAvatar(
                        backgroundColor: _getStatusColor(guru.status).withValues(alpha: 0.1),
                        child: Icon(
                      ...
                      trailing: Container(
                        ...
                        decoration: BoxDecoration(
                          color: _getStatusColor(guru.status).withValues(alpha: 0.1),
